...
const MongoDB: React.FC<SVGIconComponent> = ({ className = '' }) => {
	return (
		<svg viewBox="0 0 256 549" xmlns="http://www.w3.org/2000/svg" width="256" height="549" preserveAspectRatio="xMidYMid" className={className}>
			<g>
				<title>MongoDB</title>
