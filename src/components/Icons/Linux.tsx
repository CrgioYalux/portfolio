...
const Linux: React.FC<SVGIconComponent> = ({ className = '' }) => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width="27.77" height="32" viewBox="0 0 256 295" className={className}>
			<g>
				<title>Linux</title>
				<defs>
				...
				<g fill="none">
					<path fill="#000" fillOpacity=".2" d="M235.125 249.359c0 17.355-52.617 31.497-117.54 31.497S.044 266.806.044 249.359c0-17.356 52.618-31.498 117.54-31.498c64.924 0 117.45 14.142 117.541 31.498" filter="url(#logosLinuxTuxk)" transform="translate(10)"/>
					...
					<path fill="url(#logosLinuxTuxc)" stroke="#E68C3F" strokeWidth="6.25" d="M51.835 258.542c-20.57-10.928-50.414 2.112-39.578-27.457c2.204-6.704-3.214-16.805.275-23.325c4.133-7.989 13.04-6.244 18.366-11.57c5.234-5.51 8.54-15.06 18.366-13.59c9.734 1.468 16.254 13.406 23.049 28.099c5.05 10.468 22.865 25.253 21.672 37.007c-1.47 17.998-21.948 21.396-42.15 10.836z" transform="translate(10)"/>
